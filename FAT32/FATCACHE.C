...
#ifdef	FAT_BROWSE_CLUSTER_CACHE_ENTRIE
static	unsigned long	browse_cluster_cache_idx[FAT_BROWSE_CLUSTER_CACHE_ENTRIE];
static	unsigned long	browse_cluster_cache_data[FAT_BROWSE_CLUSTER_CACHE_ENTRIE];
#endif
...
int	fatfs_browse_cache_init(struct fatfs *fs)
{
	...
	for (i=0;i<FAT_BROWSE_CLUSTER_CACHE_ENTRIE;i++)
	{
...
// fatfs_cache_get_next_cluster:
//-----------------------------------------------------------------------------
int	fatfs_browse_cache_get_next_clu(struct fatfs *fs, UINT32 clusterIdx, UINT32 *pNextCluster)
{
#ifdef FAT_BROWSE_CLUSTER_CACHE_ENTRIE
	UINT32 slot = clusterIdx % FAT_BROWSE_CLUSTER_CACHE_ENTRIE;
...
// fatfs_cache_set_next_cluster:
//-----------------------------------------------------------------------------
int	fatfs_browse_cache_set_next_clu(struct fatfs *fs, UINT32 clusterIdx, UINT32 nextCluster)
{
#ifdef FAT_BROWSE_CLUSTER_CACHE_ENTRIE
	UINT32 slot = clusterIdx % FAT_BROWSE_CLUSTER_CACHE_ENTRIE;
